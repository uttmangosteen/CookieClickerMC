...
public class Global {
    ...
    public static final int[] amountUnLockUpGrade = {1, 5, 25, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550};
    public static final int[] amountUnLockUpGradeCursor = {1, 1, 10, 25, 50, 100, 150, 200, 250, 300, 350, 400, 450, 500};
}
