...
public class GUI {
    ...
    public static void createInventory(Player player) {
        ...
        inv.setContents(new ItemStack[] {
            createItem(Material.ARROW, 0, "§e§lカーソル", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[0]) + "クッキー", "§f§l" + playerData.buildingAmount[0] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[0]) + "§7§lクッキー生産", "§7§o「10秒毎に自動クリック」")),
            createItem(Material.PLAYER_HEAD, 0, "§e§lグランマ", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[1]) + "クッキー", "§f§l" + playerData.buildingAmount[1] + "§7§lグランマが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[1]) + "§7§lクッキー生産", "§7§o「クッキーを作ってくれる素敵なおばあちゃん」")),
            playerData.buildingAmount[1] == 0 ? itemSpace : createItem(Material.WOODEN_HOE, 0, "§e§l農場", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[2]) + "クッキー", "§f§l" + playerData.buildingAmount[2] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[2]) + "§7§lクッキー生産", "§7§o「クッキーの種からクッキーを育てます」")),
            playerData.buildingAmount[2] == 0 ? itemSpace : createItem(Material.WOODEN_PICKAXE, 0, "§e§l採掘場", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[3]) + "クッキー", "§f§l" + playerData.buildingAmount[3] + "§7§l採掘場が毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[3]) + "§7§lクッキー生産", "§7§o「クッキーの生地と串を掘り出します」")),
            playerData.buildingAmount[3] == 0 ? itemSpace : createItem(Material.STONECUTTER, 0, "§e§l工場", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[4]) + "クッキー", "§f§l" + playerData.buildingAmount[4] + "§7§l工場が毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[4]) + "§7§lクッキー生産", "§7§o「大量のクッキーを生産します」")),
            playerData.buildingAmount[4] == 0 ? itemSpace : createItem(Material.LECTERN, 0, "§e§l銀行", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[5]) + "クッキー", "§f§l" + playerData.buildingAmount[5] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[5]) + "§7§lクッキー生産", "§7§o「利子からクッキーを生み出します」")),
            playerData.buildingAmount[5] == 0 ? itemSpace : createItem(Material.CANDLE, 0, "§e§l神殿", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[6]) + "クッキー", "§f§l" + playerData.buildingAmount[6] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[6]) + "§7§lクッキー生産", "§7§o「貴重な古代クッキーの宝庫」")),
            playerData.buildingAmount[6] == 0 ? itemSpace : createItem(Material.ENCHANTING_TABLE, 0, "§e§l魔法使いの塔", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[7]) + "クッキー", "§f§l" + playerData.buildingAmount[7] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[7]) + "§7§lクッキー生産", "§7§o「魔法の呪文でクッキーを召喚します」")),
            playerData.buildingAmount[7] == 0 ? itemSpace : createItem(Material.FIREWORK_ROCKET, 0, "§e§l宇宙船", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[8]) + "クッキー", "§f§l" + playerData.buildingAmount[8] + "§7§l宇宙船が毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[8]) + "§7§lクッキー生産", "§7§o「異世界から新鮮なクッキーを輸送します」")),
            playerData.buildingAmount[8] == 0 ? itemSpace : createItem(Material.BREWING_STAND, 0, "§e§l錬金術室", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[9]) + "クッキー", "§f§l" + playerData.buildingAmount[9] + "§7§l錬金術ラボが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[9]) + "§7§lクッキー生産", "§7§o「金をクッキーに変化させます」")),
            playerData.buildingAmount[9] == 0 ? itemSpace : createItem(Material.END_PORTAL_FRAME, 0, "§e§lポータル", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[10]) + "クッキー", "§f§l" + playerData.buildingAmount[10] + "§7§lポータルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[10]) + "§7§lクッキー生産", "§7§o「クッキー界に繋がる扉を開きます」")),
            playerData.buildingAmount[10] == 0 ? itemSpace : createItem(Material.CLOCK, 0, "§e§lタイムマシン", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[11]) + "クッキー", "§f§l" + playerData.buildingAmount[11] + "§7§lタイムマシンが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[11]) + "§7§lクッキー生産", "§7§o「食べられる前のクッキーを過去から取り寄せます」")),
            playerData.buildingAmount[11] == 0 ? itemSpace : createItem(Material.END_CRYSTAL, 0, "§e§l反物質凝縮器", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[12]) + "クッキー", "§f§l" + playerData.buildingAmount[12] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[12]) + "§7§lクッキー生産", "§7§o「宇宙の反物質を圧縮しクッキーに変換します」")),
            playerData.buildingAmount[12] == 0 ? itemSpace : createItem(Material.BEACON, 0, "§e§lプリズム", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[13]) + "クッキー", "§f§l" + playerData.buildingAmount[13] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[13]) + "§7§lクッキー生産", "§7§o「光をクッキーに変換します」")),
            playerData.buildingAmount[13] == 0 ? itemSpace : createItem(Material.BELL, 0, "§e§lチャンスメーカー", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[14]) + "クッキー", "§f§l" + playerData.buildingAmount[14] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[14]) + "§7§lクッキー生産", "§7§o「無からクッキーが生まれる可能性を作ります」")),
            playerData.buildingAmount[14] == 0 ? itemSpace : createItem(Material.SPAWNER, 0, "§e§l自己無限生成エンジン", List.of("§a§l" + bigIntegerFormat(playerData.buildingPrice[15]) + "クッキー", "§f§l" + playerData.buildingAmount[15] + "§7§lカーソルが毎秒§f§l" + bigIntegerFormat(playerData.buildingCPS[15]) + "§7§lクッキー生産", "§7§o「クッキーからさらに多くのクッキーを生成します」")),
